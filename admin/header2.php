<!-- Main Header -->
  <header class="main-header">
    ...
    <a href="painel/" class="logo">
      ...
      <span class="logo-mini"><b>eS</b>C</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>e-Sports</b> Cups</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="../img/<?php echo $usuario['foto_perfil']; ?>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="../img/<?php echo $usuario['foto_perfil']; ?>" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?php echo $usuario['nome']." ".$usuario['sobrenome']; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Membro desde <?php echo date("d/m/Y", strtotime($usuario['cadastro'])); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <!--<li class="user-body">
